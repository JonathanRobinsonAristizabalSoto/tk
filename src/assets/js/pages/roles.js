...
// Renderiza el panel principal de roles y configura los eventos de búsqueda y cambio de vista
function renderRoles(vista = "tarjetas") {
  ...
  mainContent.innerHTML = `
    <div class="flex flex-col gap-2 my-1">
      <div class="flex justify-center">
        <h2 class="text-lg font-semibold text-color4 text-center flex items-center gap-2">
          <i class="fas fa-user-shield text-color6 text-base"></i>
          Roles
        </h2>
      </div>
      <div class="flex justify-center">
        <p class="text-xs sm:text-sm text-color4 text-center max-w-[400px] mb-2">
          Aquí puedes buscar, ver y editar los roles del sistema.
        </p>
      </div>
  ...
  // Evento para filtrar roles por texto
...
// Renderiza los roles en la vista seleccionada (tarjetas o tabla)
...
// Muestra el modal para editar la descripción de un rol
...
// Muestra el modal para confirmar el cambio de estado (activo/inactivo) de un rol
...
// Muestra un mensaje modal de éxito o error
...
// Obtiene los roles desde la API y los muestra
...
// Inicializa la carga y renderizado de roles
